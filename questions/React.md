...
### 9. React 16.X 中 props 改变后在哪个生命周期中处理
...
### 13. React 中怎么检验 props？验证 props 的目的是什么？
...
### 16. React setState 调用之后发生了什么？是同步还是异步？
...
### 18. Redux 中间件是什么？接受几个参数？柯里化函数两端的参数具体是什么？
...
### 26. React key 是干嘛用的 为什么要加？key 主要是解决哪一类问题的
